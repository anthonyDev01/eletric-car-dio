package com.example.myapplication.presentation.data.local
...
import com.example.myapplication.presentation.data.local.CarrosContract.CarEntry.COLUMN_NAME_CAR_ID
...
class CarRepository(private val context : Context) {
    ...
    //Listagem das colunas a serem exibidas no resultado da Querry
